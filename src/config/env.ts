...
export const API_ENDPOINTS = {
  ...
  INVESTMENTS: {
    ...
    RESUME: (id: string) => `/v1/investments/${id}/resume`,
    DUPLICATE: (id: string) => `/v1/investments/${id}/duplicate`,
    COMPLETE: (id: string) => `/v1/investments/${id}/complete`,
    ANALYTICS: (id: string) => `/v1/investments/${id}/analytics`,
    SHARED_AVAILABLE: '/v1/investments/shared/available',
    PAYOUTS: (id: string) => `/v1/investments/${id}/payouts`,
    CREATE_MANUAL_PAYOUT: (id: string) => `/v1/investments/${id}/payouts/manual`,
  },
  
  // Payouts
  PAYOUTS: {
    LIST: '/v1/payouts',
    DETAIL: (id: string) => `/v1/payouts/${id}`,
  ...
  ADMIN: {
    ...
    PARTNERS: {
      ...
      DETAIL: (id: string) => `/v1/admin/partners/${id}`,
      ...
      PERFORMANCE: (id: string) => `/v1/admin/partners/${id}/performance`,
    },
    REPORTS: {
