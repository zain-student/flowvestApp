...
export const API_ENDPOINTS = {
  ...
  INVESTMENTS: {
    ...
    CREATE_MANUAL_PAYOUT: (id: number) =>
      `/v1/investments/${id}/payouts/manual`,
    INVESTMENT_PARTNERS: (id: number) => `/v1/investments/${id}/partners`,
    ADD_PARTNER: (id: number) => `/v1/investments/${id}/partners/invite`,
    APPROVE_PARTNER: (investmentId: number, partnerId: number) =>
      `/v1/investments/${investmentId}/partners/${partnerId}/approve`,
    REMOVE_PARTNER: (investmentId: number, partnerId: number) =>
      `/v1/investments/${investmentId}/partners/${partnerId}`,
  },
  ...
  PROFILE: {
    ...
    UPDATE_COMPANY: "/v1/profile/company",
