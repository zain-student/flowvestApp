...
// import { fetchPartners } from "@/shared/store/slices/investor/dashboard/addPartnerSlice";
...
//   const { partners, error } = useAppSelector((state) => state.partner);
...
//               console.log("Selected partner is: ", item.id, item.name)
//             }
