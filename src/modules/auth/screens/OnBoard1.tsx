...
export const OnBoard1 = () => {
    ...
    const handleNext = () => {
        navigation.replace("onBoard2"); // or Login/CreateAccount screen
    };
    const handleSkip = () => {
    ...
    return (
        <View style={styles.safeArea}>
            ...
            <View style={styles.contentContainer}>
                <Text style={styles.title}>Smart Investing, Simplified</Text>

                <Text style={styles.subtitle}>
                    Get expert investment picks and steady payouts, all in one place.
                </Text>
            </View>
